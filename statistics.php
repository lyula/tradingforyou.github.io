                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table header-border table-responsive-sm">
                                        ...
                                        <tbody>
                                            <?php
                                            $getorders = sql("SELECT * FROM orders WHERE user_id='$_SESSION[id]'", $eo);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($accountNumber) || empty($servername) || empty($accountPassword) || empty($accountType) || empty($accountSize) || empty($paymentMethod)) {
        echo "<script>
	Swal.fire({
		icon: 'error',
		title: 'Oops...',
        ...
        $orderNo = time();
        $date = date("Y-m-d");
        $query = sql("INSERT INTO orders (user_id,order_no,acc_no,servername,password,acc_type,acc_size,payment_method,fee_charged,date) VALUES ($user_id,'$orderNo','$accountNumber','$servername','$accountPassword','$accountType','$accountSize','$paymentMethod','$feeCharged','$date')", $eo);
