...
<!-- Mirrored from azim.hostlin.com/Trading For You/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 May 2024 11:29:44 GMT -->
<head>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">

<title>Trading For You</title>

<!-- Fav Icon -->
<link rel="icon" href="logo four.png" type="image/x-icon">
...
<link href="assets/css/module-css/card.css" rel="stylesheet">
<link href="assets/css/module-css/exchange.css" rel="stylesheet">
...
<body>
    ...
    <div class="boxed_wrapper ltr">
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.php"><img src="TFY-cropped.png" alt="" title=""></a></div>
                ...
                <div class="slide-item p_relative">
                    ...
                    <div class="auto-container">
                        <div class="content-box">
                            ...
                            <div class="btn-box">
                                <a href="index.php" class="theme-btn btn-three">Create Account</a>
                            </div>
                        </div> 
                    </div>
                </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <figure class="image-box"><a href="service-details-2.html"><img src="assets/images/service/service-6.jpg" alt=""></a></figure>
                            <div class="inner-box">
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 card-block">
                        <div class="card-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="index.php"><img src="assets/images/resource/card-1.jpg" alt=""></a></figure>
                                <div class="lower-content">
                                    <h3><a href="index.php">Visa Silver Card</a></h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec felis tincidunt</p>
                                    <div class="btn-box">
                                        <a href="index.php" class="theme-btn btn-two">Apple for Card</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 card-block">
                        <div class="card-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="index.php"><img src="assets/images/resource/card-2.jpg" alt=""></a></figure>
                                <div class="lower-content">
                                    <h3><a href="index.php">Mastercard Gold Card</a></h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec felis tincidunt</p>
                                    <div class="btn-box">
                                        <a href="index.php" class="theme-btn btn-two">Apple for Card</a>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 card-block">
                        <div class="card-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="index.php"><img src="assets/images/resource/card-3.jpg" alt=""></a></figure>
                                <div class="lower-content">
                                    <h3><a href="index.php">Visa Platinum Card</a></h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec felis tincidunt</p>
                                    <div class="btn-box">
                                        <a href="index.php" class="theme-btn btn-two">Apple for Card</a>
                                    </div>
                ...
                <div class="row clearfix">
                    <div class="col-xl-6 col-lg-12 col-md-12 offset-xl-6 content-column">
                        <div class="content-box ml_50">
                            ...
                            <div class="btn-box">
                                <a href="index.php" class="play-store mr_20">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 form-column">
                        <div class="form-inner ml_40">
                            <form method="post" action="https://azim.hostlin.com/Trading For You/contact.html">
...
<!-- Mirrored from azim.hostlin.com/Trading For You/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 May 2024 11:29:59 GMT -->
</html>
